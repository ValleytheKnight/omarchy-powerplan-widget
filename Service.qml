...
Item {
  ...
  // This helper is installed root-owned by the omarchy-powerplan-helper
  ...
  IpcHandler {
    ...
    function status(): string {
      return JSON.stringify({
        ...
        lid: root.lidAction,
        screensaverPair: root.configState.screensaver,
        displayPair: root.configState.display,
        lockPair: root.configState.lock,
        sleepPair: root.configState.sleep,
        hibernatePair: root.configState.hibernate,
        lidPair: root.configState.lid,
